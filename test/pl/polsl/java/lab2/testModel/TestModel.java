...
public class TestModel {
    ...
    public void testAddition() {
        ...
        try {
            ...
            fail("Exception should be create, because of too short first number.");
        ...
        try {
            ...
            fail("Exception should be create, because of too short second number.");
        ...
        try {
            ...
            fail("Exception should be create, because of too short both numbers.");
        ...
        try {
            ...
            fail("Exception should be create, because first number contains "
                    + "digit other than 0 and 1.");
        ...
        try {
            ...
            fail("Exception should be create, because second number contains "
                    + "digit other than 0 and 1.");
        ...
        try {
            ...
            fail("Exception should be create, because both numbers contains "
                    + "digit other than 0 and 1.");
        ...
        try {
            ...
            fail("Exception should be create, because first number is greater "
                    + "than acceptable (1001).");
        ...
        try {
            ...
            fail("Exception should be create, because second number is greater "
                    + "than acceptable (1001).");
        ...
        try {
            ...
            fail("Exception should be create, because both numbers are greater "
                    + "than acceptable (1001).");
